...
T0 = 1048.0  # Temperature 
P0 = 1.01325e5   # Pressure
Y0 = {'CH4':0.66667, 'O2':0.33333} # Composition

#epsB = 0.45             # Voidage
epsC = 0.27              # Catalyst porosity
velocity = 2.5           # Superficial inlet velocity
cat_area_per_vol = 5.9e6 # Catalyst surface area per unit volume
