...
int main(int argc, char *argv[])
{
    ...
    // create cfdemCloud
    //Switch solveEnergy = pimple.dict().lookupOrDefault<Switch>("solveEnergy", true);
    ...
    while (runTime.run())
    {
        ...
        partVolFraction = 1.0 - voidfraction;
    ...
    Info<< "U max/min: " << gMax(U) << "/" << gMin(U) << endl;
