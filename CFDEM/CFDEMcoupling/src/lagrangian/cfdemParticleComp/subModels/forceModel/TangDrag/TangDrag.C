...
double TangDrag::F(double voidfraction, double Rep) const
{
    ...
    F0 = 10*localPhiP/Foam::pow(voidfraction, 2.0);
    
    F1 = Foam::pow(voidfraction, 2.0)*(1+1.5*Foam::pow(localPhiP, 0.5));

    F2 = Rep*(0.11*localPhiP*(1+localPhiP) - 0.00456/Foam::sqr(Foam::sqr(voidfraction)) + (0.169*voidfraction + 0.0644/Foam::sqr(Foam::sqr(voidfraction)))*Foam::pow(Rep,-0.343));
