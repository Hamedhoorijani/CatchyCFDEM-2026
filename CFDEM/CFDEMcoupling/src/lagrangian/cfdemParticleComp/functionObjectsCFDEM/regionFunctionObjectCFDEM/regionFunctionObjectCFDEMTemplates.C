...
bool Foam::functionObjectsCFDEM::regionFunctionObjectCFDEM::foundObject
(
...
template<class ObjectType>
const ObjectType& Foam::functionObjectsCFDEM::regionFunctionObjectCFDEM::lookupObject
(
    const word& fieldName
) const
{
...
template<class ObjectType>
ObjectType& Foam::functionObjectsCFDEM::regionFunctionObjectCFDEM::lookupObjectRef
(
    const word& fieldName
)
{
...
template<class ObjectType>
bool Foam::functionObjectsCFDEM::regionFunctionObjectCFDEM::store
(
