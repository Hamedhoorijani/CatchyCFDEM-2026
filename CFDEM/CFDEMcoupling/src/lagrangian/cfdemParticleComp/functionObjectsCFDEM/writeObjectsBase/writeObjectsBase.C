...
void Foam::functionObjectsCFDEM::writeObjectsBase::resetWriteObjectName
(
    const wordRe& name
)
{
...
void Foam::functionObjectsCFDEM::writeObjectsBase::resetWriteObjectNames
(
...
Foam::wordList Foam::functionObjectsCFDEM::writeObjectsBase::objectNames()
{
...
void Foam::functionObjectsCFDEM::writeObjectsBase::writeObject
(
...
Foam::functionObjectsCFDEM::writeObjectsBase::writeObjectsBase
(
...
Foam::functionObjectsCFDEM::writeObjectsBase::writeObjectNames() const
{
    return writeObjectNames_;
}


bool Foam::functionObjectsCFDEM::writeObjectsBase::read(const dictionary& dict)
{
...
bool Foam::functionObjectsCFDEM::writeObjectsBase::write()
{
