...
#include "timeControlFunctionObjectCFDEM.H"
#include "polyMesh.H"
...
void Foam::functionObjectsCFDEM::timeControl::readControls()
{
...
bool Foam::functionObjectsCFDEM::timeControl::active() const
{
    return
...
Foam::functionObjectsCFDEM::timeControl::timeControl
(
    const word& name,
    const Time& t,
...
bool Foam::functionObjectsCFDEM::timeControl::executeAtStart() const
{
    return foPtr_->executeAtStart();
}


bool Foam::functionObjectsCFDEM::timeControl::execute()
{
    if
    (
        active()
...
bool Foam::functionObjectsCFDEM::timeControl::write()
{
    if
    (
        active()
...
bool Foam::functionObjectsCFDEM::timeControl::end()
{
...
Foam::scalar Foam::functionObjectsCFDEM::timeControl::timeToNextWrite()
{
    if
    (
        active()
...
bool Foam::functionObjectsCFDEM::timeControl::read
(
    const dictionary& dict
)
{
...
void Foam::functionObjectsCFDEM::timeControl::updateMesh
(
...
void Foam::functionObjectsCFDEM::timeControl::movePoints
(
    const polyMesh& mesh
)
{
